        ...
        <div class="wrap about-wrap">
            ...
            <form id="poster-twitter-wp-admin">
                <table class="widefat fixed" cellspacing="0">
                    ...
                    <tr>
                        <th scope='row'><?php _e('Callback URL admin', poster_twitter_wp_ptwp()->nameClean(true)); ?><a class="large material-icons tooltipped" data-position="bottom" data-tooltip="<?php _e("Inserte esta url en Callback URLs ", poster_twitter_wp_ptwp()->nameClean(true)); ?>">help</a></th>
                        <td>
                    ...
                    <tr>
                        <th scope='row'><?php _e('Callback URL user', poster_twitter_wp_ptwp()->nameClean(true)); ?><a class="large material-icons tooltipped" data-position="bottom" data-tooltip="<?php _e("Inserte esta url en Callback URLs ", poster_twitter_wp_ptwp()->nameClean(true)); ?>">help</a></th>
                        <td>
                            <input type='text' name='social-poster-wp-app-oauth-ptwp' value='<?php echo admin_url().'admin.php?page=role-' . poster_twitter_wp_ptwp()->nameClean(); ?>' readonly>
                        </td>
                    </tr>
                    <tr>

...
class Admin_Poster_Twitter_WP_PTWP
{
    ...
    public function poster_twitter_wp_admin_menu_ptwp()
    {
        ...
        $help = poster_twitter_wp_ptwp()->help;
        ...
        $help = add_submenu_page('menus' . poster_twitter_wp_ptwp()->nameClean(), __('Ayuda', poster_twitter_wp_ptwp()->nameClean(true)), __('Ayuda', poster_twitter_wp_ptwp()->nameClean(true)), 'manage_options', 'help-' . poster_twitter_wp_ptwp()->nameClean(), array($help,'content'));
